...
import com.jack.ftpclient.video.LandLayoutVideo;
...
//        PlayerFactory.setPlayManager(IjkPlayerManager.class);
        ...
        FFmpegMediaMetadataRetriever mmr=new FFmpegMediaMetadataRetriever();//实例化MediaMetadataRetriever对象
//        mmr.setDataSource(getUrl(getIntent()),new HashMap<>());
...
//        Bitmap frameAtTime = mmr.getFrameAtTime();
    ...
    private String getUrl(Intent intent) {
        ...
        name = name.replaceAll("/2020上课堂","");
        name = name.replaceAll(" ","ARANARAN");
        try {
            name= URLEncoder.encode(name,"UTF-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        String url =  "http://49.235.213.253:8086/api"+ name.replaceAll("ARANARAN","%20");;
